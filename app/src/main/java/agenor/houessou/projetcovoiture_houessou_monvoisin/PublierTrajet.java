...
public class PublierTrajet extends Fragment {
     ...
     * @return A new instance of fragment PublierTrajet.
     */
    public static PublierTrajet newInstance(String param1, String param2) {
        PublierTrajet fragment = new PublierTrajet();
